...
The development of SoftEther EtherLogger was supported by the MITOH Project,
...
```sh
$ git clone https://github.com/SoftEtherVPN/EtherLogger.git
$ cd EtherLogger
$ ./configure
$ make
$ make install
